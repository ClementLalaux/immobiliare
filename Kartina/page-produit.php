            ...
            <div class="carousel">
                <div class="slide">
                    <ul class="carousel__thumbnails">
                        <li>
                            <label for="slide-1"><img src="./assets/image/page-produit/miniature-i.jpg" alt=""></label>
                        </li>
                        <li>
                ...
                <div class="miniature">
                    ...
                    <ul class="carousel__slides">
                        <li class="carousel__slide">
                            <figure>
                                <div>
                                    <img src="./assets/image/page-produit/miniature-i.jpg" alt="">
                                </div>
                            </figure>
                        </li>
                        <li class="carousel__slide">
                        ...
                        <ul>
                            <?php foreach($formats as $format) {?>
                                <li ><input type="radio"
                                            onclick="perso(e)" 
                                            name="size-format" 
                                            id="size-<?=$format->cover?>" 
                                            value="<?=$format->cover?>"
                                            data-type="<?=$format->cover?>"
                                    >
                    ...
                    <div onclick="selection(e)" id="finition" class="finition">
                        <ul>
                            <?php foreach($finitions as $finition) {?>
                                <li><input type="radio" 
                                            name="finition" 
                                            id="<?=$finition->finition?>" 
                                            value="<?=$finition->finition?>"
                                    >
                                        <img src="./assets/image/finition/<?= changeChar($finition->finition)?>.jpg" alt="">
                                        <label for="<?=$finition->finition?>"><?php echo mb_ucfirst($finition->finition);?></label>
                                </li>
                            <?php } ?>
                        </ul>
                    </div>
